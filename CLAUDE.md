...
The project is solo-operated and in MVP stage. The human is the final decision-maker on all architectural and product decisions. Claude Code's role is to propose and implement — never to decide.
