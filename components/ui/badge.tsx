...
const badgeVariants = cva(
  "inline-flex items-center gap-sm rounded-full border px-sm py-xs text-xs font-semibold text-text-primary transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-border-focus focus-visible:ring-offset-2 focus-visible:ring-offset-bg-surface [&_svg]:stroke-[1.5] [&_svg]:size-3",
  {
    variants: {
      variant: {
        default:
